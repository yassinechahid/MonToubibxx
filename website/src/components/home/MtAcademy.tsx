...
const MtAcademy = () => {
  ...
  const card2 = [
    {
      title: t("academy.cards.card1.title"),
      description: t("academy.cards.card1.description"),
    },
    {
      title: t("academy.cards.card2.title"),
      description: t("academy.cards.card2.description"),
    },
    {
      title: t("academy.cards.card3.title"),
      description: t("academy.cards.card3.description"),
    },
  ];
  return (
    <section className="flex flex-col justify-center p-6 sm:p-4">
      {/* Title */}
      <motion.header
        className="flex pb-10 pt-4 justify-center font-bold text-display-small text-light-primary text-center"
      ...
      <div className="flex w-full my-5 px-3 justify-center items-center">
